...
public interface Axes {
     ...
     */
    QuiverBuilder quiver(List<Number> u, List<Number> v, List<Number> w);
     ...
     * @return  the instance of {@link QuiverBuilder} for method chain
     */
    QuiverBuilder quiver(List<Number> x, List<Number> y,  List<Number> z, List<Number> u, List<Number> v, List<Number> w);
