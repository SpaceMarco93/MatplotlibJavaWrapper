...
public class GridBuilderImpl implements GridBuilder {
    ...
    private final CompositeAxesBuilder<GridBuilder> innerBuilder = new CompositeAxesBuilder<>(this);

    // Variable defining the builder for all the **kwargs
    private final Line3DBuilder<GridBuilder> kwargsBuilder = new Line3DBuilderImpl<>(innerBuilder);
